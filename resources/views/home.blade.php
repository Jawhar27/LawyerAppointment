    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top py-4">
       <div class="container">
              <a href="#home" class="navbar-brand">
                   <img src="img/client.png" class="mr-2" width="50" height="50" alt="">
                   <h3 class="d-inline align-middle">{{ Auth::user()->name }} </h3>
              </a>
                       ...
                       <a href="/clientprofile" class="nav-link" >Profile</a>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class=" ml-3 nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
     ...
     <section id="showcase"  class="py-5">
                              ...
                              <!-- <section id="lawyerSearch" class="bg-dark text-white py-5"> -->
                                                <div class="container ">
                                                            ...
                                                            <form action="/searchForLawyers" method="POST" role="search">
                                                            {{ csrf_field() }}
                                                            <div class="row">
                                           ...
                                           <div class="col">
                                                            <p class=" msg text-light text-center  bg-danger rounded ">{{ session('msg2')}} </p>
                                                            </div>
                                                            </div>
                                                         </form>
        ...
        <div class="col-lg-8 text-center order-1">
                       <h2 class="display-2 mt-3 pt-5">
                          <!-- Saying greetings -->
          @if($current < 12)
               Good Morning
               @elseif($current>=12 && $current < 15)
                    Good Afternoon
                @else
                    Good Evening
            ...
            @endif
                       ...
                       </h2><h2 class=" display-3"> {{ Auth::user()->name }}</h2>
              ...
              <section id="srilankaLawyers" class="my-5 text-center">
                 <div class="container">
                     ...
                     <div class="col-lg col-md-4 p-4">
                           ...
                           <a href="/neliya" class="btn btn-light text-dark w-100 m-2">Nuwara-Eliya</a>
